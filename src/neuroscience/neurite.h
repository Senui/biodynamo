...
///
BDM_SIM_CLASS(Neurite, SimulationObject) {
  BDM_CLASS_HEADER(NeuriteExt, 1, daughter_left_, daughter_right_, spring_axis_, actual_length_, tension_, spring_constant_, resting_length_);
 public:
   NeuriteExt() {}
